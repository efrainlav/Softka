Proceso TallerArreglos5
	...
	Mientras salir <> verdadero Hacer
		//Imprime la matriz 
		impMatriz(matriz, multiplicacion);
		//Llama menu de opciones para 
		Menu(opcion, fila, columna, multiplicacion, salir);
	FinMientras	
FinProceso
...
SubProceso impMatriz(matriz Por Referencia, multiplicacion Por Referencia)
	definir fila, columna, num1, num2 como entero;
	definir label Como Caracter;
	Label<-"COLUMNA";
	Escribir "---------------------------------",Label,"-------------------------------------------";
...
subproceso Menu(opcion por referencia, fila por referencia, columna por referencia, multiplicacion por referencia, salir Por Referencia )
	Escribir "";
