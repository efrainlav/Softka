	...
	Mientras salir1 <> Verdadero Hacer
		...
		Segun opcion Hacer
			1:
				...
				crearCliente(idTemp, posicion, j, id, nombreCompleto, cuentas);
		
			
			2:
				//Funcion tansacciones cliente
				transacciones(salir2, transaccion, idTemp, posicion,deposito, depositoTemp, retiroTemp, nombreCompleto, id, j);
...
//FUncion para crear un cliente
subproceso crearCliente(idTemp Por Referencia, posicion Por Referencia, j Por Referencia, id Por Referencia, nombreCompleto Por Referencia, cuentas Por Referencia)
	//Rectangulo				
	Escribir "1. Crear Cliente.";
...
//Funcion transacciones cliente
subproceso transacciones(salir2 Por Referencia, transaccion Por Referencia, idTemp Por Referencia, posicion Por Referencia,deposito Por Referencia, depositoTemp Por Referencia, retiroTemp Por Referencia, nombreCompleto Por Referencia, id Por Referencia, j Por Referencia)
